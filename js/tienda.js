...
// Imprimir en el documento el producto  
        ...
        for (let i = 0; i < 4; i++) {
            ...
            switch (i) { 
                case 0:
                    ...
                    div.appendChild(h2);
                    input.value = `${arrayProductos[idButton-1].nombreProducto}`;
                ...
                case 1:
                    ...
                    input.value = `${arrayProductos[idButton-1].cantidad}`;
                    input.setAttribute("class", `inputs-vista-previa`);
                ...
                case 2:
                    input.setAttribute("type","number");
                    input.value = `${arrayProductos[idButton-1].precio}`;
                    input.setAttribute("class", `inputs-vista-previa`);
